...
public class T2_Calendar {
	public static void main(String[] args) {
		...
		System.out.println("월 : " + (cal.get(Calendar.MONTH)+1)); // 월은 0월부터 나옴. +1을 항상 해야 함..
		System.out.println("일 : " + cal.get(Calendar.DATE));
		System.out.println("시 : " + cal.get(Calendar.HOUR_OF_DAY)); // 그냥 hour로 꺼내면 안됨
		System.out.println("분 : " + cal.get(Calendar.MINUTE));
		System.out.println("초 : " + cal.get(Calendar.SECOND));
		System.out.println("오늘이 몇번째 주? : " + cal.get(Calendar.WEEK_OF_YEAR));
		System.out.println("오늘이 몇번째 일? : " + cal.get(Calendar.DAY_OF_WEEK)); // 일요일이 시작. 일(1), 월(2),~~~토(7)
