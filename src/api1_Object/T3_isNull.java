...
public class T3_isNull {
	public static void main(String[] args) {
		...
		if(Objects.isNull(vo)) System.out.println("3. vo는 null입니다."); // 메소드(Objects.isNull(vo))를 통해서 비교
		else System.out.println("3. vo는 null이 아닙니다.");
		System.out.println();
	
		if(Objects.nonNull(vo)) System.out.println("4. vo는 nulll이 아닙니다."); // 메소드(Objects.nonNull(vo))를 통해서 비교
...
//			else System.out.println("방문객");
		...
		vo.setName(null);
	//	System.out.println("7. name은 "+ Objects.requireNonNull(vo.getName()) +"입니다."); 
