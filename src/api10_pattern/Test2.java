...
// 영문자와 숫자 포함 유무: ^[\\w]*$ -> 영문자, 숫자가 0개 이상 포함이라는 뜻 (포함시 참, 없으면 거짓)
public class Test2 {
	public static void main(String[] args) {
		String regEx1 = "^[\\w]*$";
		
		String str1 = "hello"; // 모두 영문자로 구성
		String str2 = "hello1234"; // 모두 영문자와 숫자로 구성
		String str3 = "hello12!!"; // 모두 영문자와 숫자, 기호로 구성
		String str4 = "hello    "; // 모두 영문자와 공백으로 구성
		String str5 = "안녕"; // 모두 한글로 구성
		
		if(Pattern.matches(regEx1, str1)) System.out.println("1.영문자와 숫자로 구성되어있습니다.");
		else System.out.println("1.영문자와 숫자가 아닌 문자가 포함되어있습니다.");
		...
		String regEx2 = "^[\\W]*$";
		if(Pattern.matches(regEx2, str1)) System.out.println("1.영문자와 숫자가 아닌 문자만 포함되어있습니다.");
		else System.out.println("11.영문자와 숫자로 구성되어있습니다.");
