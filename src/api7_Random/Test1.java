...
public class Test1 {
	public static void main(String[] args) {
		...
		System.out.println(random.nextInt());     // 2의 32승형 정수형 난수 발생
		System.out.println(random.nextLong());    // 2의 64승형 정수형 난수 발생
		...
		// 클래스 안의 매개값으로 난수를 고정시킬 수 있다. (승부조작)
