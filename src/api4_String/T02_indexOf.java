...
public class T02_indexOf {
	public static void main(String[] args) {
		...
		// indexOf() : 찾고자하는 문자(열)이 있는가를 표시 -> 있으면 위치값(인덱스값)을 반환, 없으면 -1을 반환
		System.out.println("1.msg1에 'O'문자가 있는가? " + msg1.indexOf("O"));
		System.out.println("2.msg1에 'o'문자가 있는가? " + msg1.indexOf("o")); // 앞에서부터 위치값 1개만 나옴
		...
		System.out.println(".msg1에 'o'문자가 있는가? " + msg1.lastIndexOf("o")); // 뒤에서부터 찾고 앞에서부터의 위치가 나옴
	}
}
